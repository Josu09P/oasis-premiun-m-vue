    ...
    <header class="d-flex justify-content-between align-items-center px-4 py-3 header-top">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="d-flex align-items-center gap-2">
                <span style="color: #52667d !important;">Temas</span>
                <i class="bi bi-palette" style="color: #52667d !important;"></i>
            </div>
            <div class="d-flex align-items-center gap-2">
                <img src="#" id="user-image" class="rounded-circle" width="26" height="26" />
                <span id="user-name" style="color: #52667d !important;"></span>
                <i class="bi bi-person-circle" style="color: #52667d !important;"></i>
            </div>
            <div class="bounce-effect user-logout">
                <i class="bi bi-door-open" id="cerrar-sesion" style="color: #52667d !important;"></i>
            </div>
        </div>
    </header>
</template>
